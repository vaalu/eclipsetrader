...
import org.eclipsetrader.google.internal.core.repository.IdentifierType;
import org.eclipsetrader.google.internal.core.repository.IdentifiersList;
import org.eclipsetrader.google.internal.core.repository.PriceDataType;
...
public class SnapshotConnector implements Runnable, IFeedConnector, IExecutableExtension, PropertyChangeListener {
    ...
    public void disconnect() {
        ...
        if (thread != null) {
            try {
                ...
                Status status = new Status(IStatus.ERROR, GoogleActivator.PLUGIN_ID, 0, "Error stopping thread", e);
    ...
    public void run() {
        try {
            ...
            Status status = new Status(IStatus.ERROR, GoogleActivator.PLUGIN_ID, 0, "Error reading data", e);
            GoogleActivator.log(status);
        }
    }
    ...
    protected void fetchLatestSnapshot(HttpClient client, String[] symbols, boolean isStaleUpdate) {
        ...
        try {
            ...
            try {
                ...
                Status status = new Status(IStatus.WARNING, GoogleActivator.PLUGIN_ID, 0, "Connection wasn't closed cleanly", e);
                GoogleActivator.log(status);
            }
        }
    }
    ...
    protected Date getDateValue(String dateValue, String timeValue) {
        ...
        try {
            ...
            Status status = new Status(IStatus.ERROR, GoogleActivator.PLUGIN_ID, 0, "Error parsing date/time values", e);
            GoogleActivator.log(status);
        }
    ...
    protected Double getDoubleValue(String value) {
        try {
            ...
            Status status = new Status(IStatus.ERROR, GoogleActivator.PLUGIN_ID, 0, "Error parsing number", e);
            GoogleActivator.log(status);
        }
        return null;
    }
