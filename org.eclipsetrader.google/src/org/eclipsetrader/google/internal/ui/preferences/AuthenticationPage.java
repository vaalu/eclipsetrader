...
import org.eclipsetrader.google.internal.core.connector.SnapshotConnector;
import org.eclipsetrader.google.internal.core.connector.StreamingConnector;
...
public class AuthenticationPage extends PreferencePage implements IWorkbenchPreferencePage {
    ...
    public void init(IWorkbench workbench) {
        setPreferenceStore(GoogleActivator.getDefault().getPreferenceStore());
    }
    ...
    protected void performApply() {
        switch (driver.getSelectionIndex()) {
            case 0:
                getPreferenceStore().setValue(GoogleActivator.PREFS_DRIVER, StreamingConnector.class.getName());
                break;
            case 1:
                getPreferenceStore().setValue(GoogleActivator.PREFS_DRIVER, SnapshotConnector.class.getName());
                break;
        }
    }
    ...
    protected int getDriverIndex() {
        String driver = getPreferenceStore().getString(GoogleActivator.PREFS_DRIVER);
