...
package org.eclipsetrader.google.internal.ui.wizards;
...
import org.eclipsetrader.google.internal.core.connector.BackfillConnector;
                ...
                try {
                    ...
                    if (identifier != null) {
                        ...
                        if (dataMap.size() == timeSpan.length) {
                            ...
                            Status status = new Status(IStatus.WARNING, GoogleActivator.PLUGIN_ID, 0, "Missing data for " + security.getName(), null);
                            GoogleActivator.log(status);
                        }
                    }
                } catch (Exception e) {
                    Status status = new Status(IStatus.ERROR, GoogleActivator.PLUGIN_ID, 0, "Error downloading data for " + security, e);
                    GoogleActivator.log(status);
                }
