...
public class ImportDataPage extends WizardPage {
    ...
    protected void restoreState() {
        IDialogSettings dialogSettings = GoogleActivator.getDefault().getDialogSettings().getSection(getClass().getName());
    ...
    public void saveState() {
        IDialogSettings dialogSettings = GoogleActivator.getDefault().getDialogSettings().getSection(getClass().getName());
        if (dialogSettings == null) {
            dialogSettings = GoogleActivator.getDefault().getDialogSettings().addNewSection(getClass().getName());
        }
