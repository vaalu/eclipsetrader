...
public class Nifty50WizardPage extends WizardPage {

    Text name;
    MarketService marketService;

    public Nifty50WizardPage(MarketService marketService) {
        super("general", "Nifty50", null);
