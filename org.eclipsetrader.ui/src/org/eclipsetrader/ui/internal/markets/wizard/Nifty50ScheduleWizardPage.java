...
public class Nifty50ScheduleWizardPage extends WizardPage {

	Nifty50TimeScheduleEditor schedule;
    Button sun;
    Button mon;
    Button tue;
    Button wed;
    ...
    public Nifty50ScheduleWizardPage() {
    ...
    public void createControl(Composite parent) {
        ...
        schedule = new Nifty50TimeScheduleEditor(content);
        ...
        schedule.getInput().add(new MarketTimeElement(getTime(9, 15), getTime(15, 30)));
